...
//added for password retrieval
$_SESSION['email'] = $email;
$_SESSION['start']=time();

header('Location: client_workspace.php');
exit;
          ...
          <tr>
            <td width="100%" height="44" align="center" valign="top"><table width="927" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="166"><img src="images/Layout-2_09.jpg" width="166" height="104"></td>
                <td width="58"><img src="images/Layout-2_10.jpg" width="66" height="104"></td>
              </tr>
            </table></td>
            </tr>
          <tr>
            <td height="506" valign="top"><table width="61%" height="534" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="center" valign="top" bgcolor="#F4EED6" class="style2"><form action="" method="post">
<?php
if (isset($error)) {
...
<table name="tbl_client_login" width="310">
<tr><td colspan="2" class="loginTitle"><div align="center">Client Login</div></td>
</tr>
<tr height="10px"><td width="94">&nbsp;</td>
</tr>
<tr><td><img src="images/email.jpg" width="113" height="24" /></td><td width="197"><input name="client_username" size="30" maxlength="30" tye="text" /></td></tr>
<tr><td><img src="images/password.jpg" width="113" height="24" /></td><td><input name="client_password" type="password" size="30" maxlength="30" /></td></tr><tr><td>&nbsp;</td></tr>
<tr><td></td><td><input type="submit" name="login" class="btn" value="Login" />
</td></tr></table>
</form></td>
